        ...
        {#each uploadedFiles as file}
            <div id="uploadedFileContainer" class="uploadedFileContainer">
                <div class="uploadedFileContainer__fileContent">
                    <div
                        class="uploadedFileContainer__fileConten__fileContentIcon green"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                    ...
                    <div class="uploadedFileContainer__fileParams">
                        <div
                            class="uploadedFileContainer__fileParams__fileName"
                        >
                            {file.fileName}
                        </div>
                        <div
                            class="uploadedFileContainer__fileParams__fileIcons"
                        >
...
<style>
    ...
    .uploadedFileContainer
        .uploadedFileContainer__fileContent
        > div:first-child {
        float: left;
    }
    ...
    .uploadedFileContainer
        .uploadedFileContainer__fileContent
        .uploadedFileContainer__fileParams {
        position: relative;
        margin-left: 32px;
        display: flex;
    }
    ...
    .uploadedFileContainer
        .uploadedFileContainer__fileContent
        .uploadedFileContainer__fileParams__fileName {
        flex: auto;
        position: relative;
        width: 100%;
        line-height: 24px;
    ...
    .uploadedFileContainer
        .uploadedFileContainer__fileContent
        .uploadedFileContainer__fileParams__fileIcons {
        display: flex;
        cursor: pointer;
        flex: 0 0 8px;
        align-self: center;
    ...
    .uploadedFileContainer
        .uploadedFileContainer__fileContent
        .uploadedFileContainer__fileParams__fileIcons:hover
        svg
        path {
        fill: #2e3238;
    }
