...
declare type FilePatch = {
    readonly type: typeof PatchType_2.DOCUMENT;
    readonly children: readonly FileChild[];
};

declare type FilePatch_2 = {
...
declare type InputDataType_2 = Buffer | string | number[] | Uint8Array | ArrayBuffer | Blob | NodeJS.ReadableStream | default_2;
...
export declare type IPatch = ParagraphPatch_2 | FilePatch_2;

declare type IPatch_2 = ParagraphPatch | FilePatch;
...
export declare function ITAM_processFileAndFindPlacesToReplace(blob: Blob): Promise<[Blob, ProcessingTemplateResult[]]>;

export declare function ITAM_replaceTemplateFieldsInDocxAndGetOutputBuffer(patches: TypeToReplaceTemplates[], inputArrayBuffer: Blob): Promise<Buffer>;
...
declare type ParagraphPatch = {
    readonly type: typeof PatchType_2.PARAGRAPH;
    readonly children: readonly ParagraphChild[];
};

declare type ParagraphPatch_2 = {
...
export declare const patchDocument: <T extends keyof OutputByType = keyof OutputByType>({ outputType, data, patches, keepOriginalStyles, placeholderDelimiters, recursive, }: PatchDocumentOptions<T>, beforeJsonCallbacks?: ((json: Element_2, context: IContext) => void)[], afterJsonCallbacks?: ((json: Element_2, context: IContext) => void)[]) => Promise<OutputByType[T]>;
...
declare type PatchDocumentOutputType_2 = OutputType;

declare class PatchGenerator {
    private i;
    createdPatches: PatchGeneratorReturnType[];
    constructor();
    nextPatch(sourceString: string): PatchGeneratorReturnType;
}

declare type PatchGeneratorReturnType = {
    patch: IPatch_2;
    parentTableElementRef: Element_2 | null;
    parentRowElementRef: Element_2 | null;
    patchString: string;
    sourceString: string;
};
...
declare type ProcessingTemplateResult = {
    sourceString: string;
...
export declare const regexPatchDocument: <T extends keyof OutputByType = keyof OutputByType>({ outputType, data, patchGenerator, keepOriginalStyles, placeholderDelimiters, recursive, }: RegexPatchDocumentOptions<T>, ...jsonCallbacks: ((json: Element_2) => void)[]) => Promise<OutputByType[T]>;

declare type RegexPatchDocumentOptions<T extends PatchDocumentOutputType_2 = PatchDocumentOutputType_2> = {
    readonly outputType: T;
    readonly data: InputDataType_2;
...
export declare class RegexReplacer {
    doReplace({ json, patchGenerator, patchRegex, context, keepOriginalStyles, }: {
        readonly json: Element_2;
        readonly patchGenerator: PatchGenerator;
        readonly patchRegex: RegExp;
...
declare type TypeToReplaceTemplates = {
